...
if __name__ == '__main__':
    ...
    parser.add_argument('--model_path', type=str, default= os.path.join('results','obs17_12_lidar_nowind_randtarget_save-02.28.2026_12.02.07', 'final_model'), help='Ruta al archivo .zip del modelo PPO')
