...
if __name__ == '__main__':
    ...
    parser.add_argument('--model_path', type=str, default= os.path.join('results', 'new_relative_target-04.09.2026_19.30.49', 'final_model'), help='Ruta al archivo .zip del modelo PPO')
